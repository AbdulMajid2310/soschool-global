...
import ImportStudentCsvSection from "@/components/student/add/ImportStudentCsvSection";
import CreateStudentSection from "@/components/student/add/createdStudentSection";
import CreatedStudentList from "@/components/student/add/CreatedStudentList";
  ...
  return (
    <div className="min-h-screen p-4  animate-in fade-in duration-500">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
        {mode === "single" && <CreateStudentSection />}

        {mode === "bulk" && <ImportStudentCsvSection />}

        {mode === "list" && <CreatedStudentList />}
      </div>
    </div>
  );
}
