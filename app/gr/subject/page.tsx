              ...
              <div key={cls.id} className="group p-6 rounded-[2.5rem] border border-slate-50 dark:border-white/5 hover:border-violet-500/30 transition-all flex flex-wrap items-center justify-between gap-6">
                ...
                <div className="flex gap-10">
                  ...
                  <div className="hidden md:block">
                    <p className="text-[8px] font-black text-slate-400 uppercase italic mb-1">Perilaku</p>
                ...
                <button onClick={() => router.push('akademik/detail')} className="p-4 bg-slate-50 dark:bg-white/5 rounded-2xl text-slate-400 group-hover:bg-violet-600 group-hover:text-white transition-all shadow-xs group-hover:shadow-violet-500/20">
                  <FiArrowRight />
                </button>
              </div>
            ))}
