  ...
  return (
    <div className="group bg-white dark:bg-zinc-900/50 border border-slate-200 dark:border-white/5 rounded-4xl p-1 shadow-xs hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-500/50 transition-all duration-500 overflow-hidden">
      ...
      <div className="p-4 space-y-5">
        ...
        {/* Action Button */}
        <button
          onClick={() => router.push('/bank-soal/detail')}
          className={`w-full py-4 rounded-3xl font-black text-[10px] tracking-[0.2em] uppercase transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2 ${isDone
