...
import ImportStaffExcel from "./ImportStaffExcel";
    ...
    return (
        <div className="p-4 md:p-10 max-w-7xl mx-auto space-y-10 font-sans">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex bg-gray-100 dark:bg-gray-800 p-1.5 rounded-4xl shadow-inner">
                    <button
                        ...
                        className={`flex items-center gap-3 px-6 py-3 rounded-3xl text-xs font-black uppercase tracking-widest transition-all ${method === "single" ? "bg-white dark:bg-gray-700 text-indigo-600 shadow-xl" : "text-gray-500"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 px-6 py-3 rounded-3xl text-xs font-black uppercase tracking-widest transition-all ${method === "excel" ? "bg-white dark:bg-gray-700 text-indigo-600 shadow-xl" : "text-gray-500"
                            }`}
                    >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800">
                {method === "single" ? <AddSingleStaff /> : <ImportStaffExcel />}
            </div>
        </div>
    );
}