...
const SubjectDetail = () => {
    ...
    const { currentSubject, loading, } = useAppSelector((state) => state.schoolSubject);
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-100 space-y-4">
            ...
            <p className="text-slate-500 font-medium animate-pulse">Menyiapkan ruang kelas...</p>
        </div>
    );
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-20">
            ...
            <button
                ...
                className="flex items-center gap-2 text-slate-500 hover:text-blue-600 transition-colors font-bold text-sm uppercase tracking-widest cursor-pointer"
            >
                <HiOutlineArrowLeft strokeWidth={2.5} /> Kembali ke Kurikulum
            </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-4xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs relative overflow-hidden group">
                        ...
                        {/* Sparkle Decoration */}
                        <HiOutlineSparkles className="absolute -bottom-4 -right-4 text-blue-500/5 group-hover:text-blue-500/10 transition-colors" size={120} />
                    </div>

                    {/* Quick Info Card */}
                    <div className="bg-linear-to-br from-slate-900 to-slate-800 rounded-2xl p-6 text-white">
                        <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-slate-400 mb-4">Informasi Kelas</h4>
                        <div className="space-y-4">
