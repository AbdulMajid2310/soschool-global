...
import {
    FaChartLine, FaMoneyBillWave, FaUsers, FaGraduationCap,
    FaTrophy, FaExclamationTriangle, FaArrowRight
} from 'react-icons/fa';
...
export const dataLaporanTerpadu = {
    ...
    kehadiran: {
        ...
        kelasTerendah: rekapKehadiranKelas.sort((a, b) => a.persentaseKehadiran - b.persentaseKehadiran)[0],
...
import { laporanKehadiranSiswaSummary, rekapKehadiranKelas } from './kehadiran/page';
...
export default function LaporanTerpaduPage() {
    ...
    const MainKPICard: React.FC<{
        ...
        <Link href={linkHref} className={`${color} rounded-xl shadow-lg p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl block`}>
        ...
        <main className="min-h-screen bg-gray-100 dark:bg-gray-900">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">Analisis komprehensif kinerja akademik, keuangan, dan kehadiran sekolah.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                            ...
                            5 Kelas dengan Nilai Tertinggi
                        </h2>
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Rincian Pengeluaran Bulan Ini</h2>
                        <ResponsiveContainer width="100%" height={300}>
                            <PieChart>
                                <Pie
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Tren Kehadiran Siswa (6 Bulan Terakhir)</h2>
                        <ResponsiveContainer width="100%" height={250}>
                            <LineChart data={kehadiran.trend}>
                                ...
                                <YAxis />
                                <Tooltip />
                                <Line type="monotone" dataKey="persentase" stroke="#F97316" strokeWidth={2} />
                            </LineChart>
                        </ResponsiveContainer>
                    </section>
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Tren Pemasukan (6 Bulan Terakhir)</h2>
                        <ResponsiveContainer width="100%" height={250}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-red-500">
                        ...
                        {kehadiran.kelasTerendah ? (
                            <div>
                                <p className="text-2xl font-bold text-red-600 dark:text-red-400">{kehadiran.kelasTerendah.namaKelas}</p>
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    Tingkat kehadiran hanya <span className="font-semibold">{kehadiran.kelasTerendah.persentaseKehadiran.toFixed(1)}%</span> bulan ini.
                                </p>
                                <Link href="/laporan-kehadiran" className="inline-flex items-center text-sm font-medium text-red-600 dark:text-red-400 hover:underline mt-3">
                    ...
                    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
                        ...
                        {keuangan.pengeluaranPerKategori[0] && (
                            <div>
                                <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">{keuangan.pengeluaranPerKategori[0].kategori}</p>
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    Menyerap <span className="font-semibold">{formatRupiah(keuangan.pengeluaranPerKategori[0].jumlah)}</span> atau{' '}
                                    <span className="font-semibold">
                                        {((keuangan.pengeluaranPerKategori[0].jumlah / keuangan.summary.totalPengeluaran) * 100).toFixed(1)}%
                                    </span> dari total pengeluaran.
                                </p>
                                <Link href="/laporan-keuangan" className="inline-flex items-center text-sm font-medium text-orange-600 dark:text-orange-400 hover:underline mt-3">
                                    Lihat Detail Laporan
                                    <FaArrowRight className="ml-1" />
                                </Link>
                            </div>
