        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 border-4 border-dashed border-slate-100 dark:border-slate-800 rounded-[3rem] bg-slate-50/30 dark:bg-slate-900/20">
                    <HiOutlineBookOpen className="mx-auto text-slate-200 dark:text-slate-800 mb-4" size={64} />
                    <p className="text-slate-400 font-black text-xs uppercase tracking-widest">Belum ada materi pembelajaran</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 gap-4">
                    {materials.map((m) => (
