...
export default function HeaderProfile({ isOwnProfile = true }) {
  ...
  const tabs = [
    { id: "posts", label: "Insights", path: "/profile" },
    { id: "about", label: "Postingan", path: "/profile/postingan" },
    { id: "projects", label: "Galeri", path: "/profile/galeri" },
  ];
      ...
      <div className="relative bg-white dark:bg-[#0a0a0b] md:rounded-4xl overflow-hidden border border-slate-200 dark:border-white/5 shadow-2xl">
        ...
        <div className="relative h-48 md:h-72 overflow-hidden">
          ...
          <div className="absolute top-6 right-6 flex gap-2">
            <button
              title="edit"
              className="p-2.5 bg-black/20 backdrop-blur-xl border border-white/10 rounded-xl text-white hover:bg-blue-600 transition-all cursor-pointer"
            >
