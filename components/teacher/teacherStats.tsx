    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {statItems.map((item, i) => (
                <div
                    key={i}
                    className={`relative overflow-hidden group p-6 rounded-[2.5rem] border border-white dark:border-gray-800  backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-gray-200 dark:hover:shadow-none`}
                >
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="flex items-center gap-1 px-2 py-1 bg-white dark:bg-gray-800 rounded-full border border-white dark:border-gray-700 shadow-sm">
                        ...
                        <div className="flex gap-4 mt-5">
                            <div>
                                ...
                                <div className={`flex text-4xl items-center dark:text-white text-gray-700 justify-center size-12 rounded-2xl  shadow-inner`}>
                                    {item.icon}
                                </div>
                            </div>
                            <div className="">
