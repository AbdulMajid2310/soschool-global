  ...
  async (schoolId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal mengambil data guru",
      );
    }
  },
);
...
export const fetchTeacherDetail = createAsyncThunk(
  "teacher/fetchOne",
  async (
    payload: { schoolId: string; teacherId: string },
    { rejectWithValue },
  ) => {
    try {
      const response = await teacherService.getOneBySchool(
        payload.schoolId,
        payload.teacherId,
      );
      return response.data;
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal mengambil detail guru",
      );
    }
  },
);
...
export const fetchTeacherProfile = createAsyncThunk(
  ...
  async (
    payload: { schoolId: string; userId: string },
    { rejectWithValue },
  ) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal memuat profil pengajar",
      );
    }
  },
);
...
export const registerTeacher = createAsyncThunk(
  ...
  async (payload: CreateTeacherPayload, { rejectWithValue, dispatch }) => {
    try {
      ...
      return rejectWithValue(
        Array.isArray(msg) ? msg[0] : msg || "Gagal mendaftarkan guru",
      );
    }
  },
);
...
export const importTeacherCsv = createAsyncThunk(
  ...
  async (
    ...
    try {
      const response = await teacherService.importCsv(
        payload.schoolId,
        payload.file,
      );
      dispatch(fetchTeachers(payload.schoolId));
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal mengimport data guru",
      );
    }
  },
);
...
export const updateTeacherData = createAsyncThunk(
  "teacher/update",
  async (
    payload: { id: string; schoolId: string; data: any },
    { rejectWithValue, dispatch },
  ) => {
    try {
      const response = await teacherService.update(
        payload.schoolId,
        payload.id,
        payload.data,
      );
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal update data guru",
      );
    }
  },
);
...
export const toggleTeacherStatus = createAsyncThunk(
  ...
  async (
    payload: { teacherId: string; schoolId: string; isActive: boolean },
    { rejectWithValue, dispatch },
  ) => {
    try {
      const response = await teacherService.updateStatus(
        payload.teacherId,
        payload.isActive,
      );
      dispatch(fetchTeachers(payload.schoolId));
...
// Thunk Baru untuk Hapus Massal
export const deleteBulkTeachers = createAsyncThunk(
  "teacher/deleteBulk",
  async (
    ...
    try {
      const response = await teacherService.deleteBulk(
        payload.schoolId,
        payload.userIds,
      );
      dispatch(fetchTeachers(payload.schoolId));
