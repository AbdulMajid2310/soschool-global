  ...
  async (schoolId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal memuat mata pelajaran",
      );
    }
  },
);
...
export const fetchSubjectDetail = createAsyncThunk(
  ...
  async (subjectId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal memuat detail mata pelajaran",
      );
    }
  },
);
...
export const createSubject = createAsyncThunk(
  ...
  async (payload: CreateSubjectPayload, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.message || "Gagal membuat mata pelajaran",
      );
    }
  },
);

export const createBulkSubject = createAsyncThunk(
  "subject/createBulk",
  async (payload: CreateBulkSubjectPayload, { rejectWithValue }) => {
    try {
      const res = await subjectService.createBulk(payload);
      return res.data;
    } catch (err: any) {
      return rejectWithValue(
        err.response?.data?.message || "Gagal membuat data masal",
      );
    }
  },
);
